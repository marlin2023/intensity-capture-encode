...
all:  
	...
	gcc -D_CHRIS -g -pg -c segment_utils.c segment_yy.c	input_handle.c 	output_handle.c	rtmp_mux.c -I${include_path}  
	gcc *.o -g -pg -D_CHRIS  -o capture -lstdc++  -L${lib_path} -lavformat -lavcodec  -lswscale -lswresample -lavutil -lm -ldl -lz -lpthread -lx264 -L./ -lfaac -ljpeg
